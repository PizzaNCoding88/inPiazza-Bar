          ...
          <div className="storia_container text-black">
            ...
            <div className="lg:flex lg:flex-row lg:items-center gap-8">
              ...
              <p className="text-xl mt-6 lg:text-2xl xl:text-3xl">
                ...
                lounge! <br /> <br /> Siamo due amici che, dopo anni di duro
                lavoro, sacrifici e sogni, abbiamo finalmente deciso di
                realizzare il nostro sogno aprendo un bar che offrisse
