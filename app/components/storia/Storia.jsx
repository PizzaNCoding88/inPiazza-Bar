      ...
      <main className="font-antic">
        ...
        <section className="bg-primary">
          <div className="storia_container text-white">
            ...
            <p className="text-xl">
              I nostri cocktail sono studiati attentamente, utilizzando solo gli
              ingredienti più freschi e di prima qualità. Ogni drink è una
              ...
              creazioni inedite, le nostre bevande sono pensate per sorprendere
              e deliziare ogni vostro palato.
            </p>
          </div>
        </section>
        ...
        <section className="bg-primary">
          <div className="storia_container text-white">
            ...
            <p className="text-xl">
              Il nostro locale è un&apos;oasi di relax e divertimento, un luogo
              in cui potrete trascorrere piacevoli serate in compagnia di amici
              o familiari. <br />
              <br />
              Abbiamo curato ogni dettaglio dell&apos;arredamento per creare
              un&apos;atmosfera accogliente, sofisticata e contemporanea, in cui
              potrete sentirvi a vostro agio.
            </p>
          </div>
        </section>
