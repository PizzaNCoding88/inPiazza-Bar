      ...
      >
        <div className="container">
          ...
          <p className="title1">
            ...
            solo alle informazioni raccolte tramite il sito e non si applica
            alle informazioni raccolte offline o tramite altri canali.
          </p>
            ...
            <li className="titles">
              ...
              <ol>
                ...
                <li>
                  ...
                  personali con le autorità competenti per rispondere a
                  richieste legittime, conformarsi ai requisiti legali o
                  proteggere i nostri diritti, la nostra proprietà o la nostra
                  sicurezza.
                </li>
              </ol>
            </li>
            <li className="titles">
              ...
              <ol>
                <li>
                  ...
                  divulgazione o dall&apos;alterazione. Tuttavia, nessun metodo
                  di trasmissione o di archiviazione elettronica è sicuro al
                  100%.{" "}
                </li>
                <li>
            ...
            <li className="titles">
              ...
              <ol>
                <li>
                  ...
                  parti. Non siamo responsabili delle pratiche sulla privacy o
                  del contenuto di tali siti. Ti invitiamo a leggere le
                  politiche sulla privacy di tali siti prima di fornire loro
            ...
            <li className="titles">
              ...
              <ol>
                <li>
                  ...
                  Privacy Policy di tanto in tanto. Ti consigliamo di rivedere
                  periodicamente questa pagina per essere informato sulle
                  eventuali modifiche. L&apos;utilizzo continuato del nostro
                  sito costituisce la tua accettazione di tali modifiche.
                </li>
              </ol>
            </li>
            <li className="titles">
          ...
          <p className="bottom">
            ...
            raccolta, all&apos;utilizzo e alla divulgazione delle tue
            informazioni personali come descritto nella presente politica
          </p>
        </div>
      </motion.main>
    </>
