      ...
      <div className="container">
        ...
        <ol>
          ...
          <ol>
            <li>
              ...
              informazioni personali fornite volontariamente dagli utenti, come
              il nome, l&apos;indirizzo e-mail, il numero di telefono,
            ...
            <li>
              ...
              navigazione, la data e l&apos;ora di accesso. Queste informazioni
              vengono raccolte per analizzare le tendenze, amministrare il sito
              e raccogliere informazioni demografiche aggregate.{" "}
            </li>
          </ol>
        </ol>
        <li className="titles">
          ...
          <ol>
            <li>
              ...
              personalizzati, inviare comunicazioni promozionali, migliorare il
              nostro sito e per scopi interni di ricerca e analisi.
            </li>
            <li>
        ...
        <li className="titles">
          ...
          <ol>
            ...
            <li>
              Conserviamo le informazioni personali solo per il tempo necessario
              al raggiungimento delle finalità per cui sono state raccolte.
            </li>
          </ol>
        </li>
        <li className="titles">
          ...
          <ol>
            <li>
              ...
              contenuto di tali siti. Ti invitiamo a leggere le politiche sulla
              privacy di tali siti prima di fornire loro qualsiasi informazione
              personale.
            </li>
          </ol>
        </li>
        <li className="titles">
          ...
          <ol>
            <li>
              ...
              periodicamente questa pagina per essere informato sulle eventuali
              modifiche. L&apos;utilizzo continuato del nostro sito costituisce
              la tua accettazione di tali modifiche.
            </li>
          </ol>
        </li>
        <li className="titles">
